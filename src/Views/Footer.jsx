      ...
      <footer className="relative bg-cust-purple w-full">
        ...
        <div className="w-full cust-outer-container">
          ...
          <div className="flex flex-col md:flex-row cust-container py-2">
            ...
            <div className="md:absolute md:top-0 md:right-14 lg:right-20 xl:right-24 rounded-b-xl drop-shadow-[0_20px_22px_rgb(0,0,0,0.3)] lg:pt-20 px-5 pb-5 md:bg-gradient-to-t md:from-cust-pink md:to-cust-purple">
              <div
                onClick={() => handleClick(scrollTo)}
                className="flex mx-auto w-fit rounded-full bg-gradient-to-t from-cust-yellow to-cust-violet animate-bounce mt-10 cursor-pointer drop-shadow-lg"
              >
                <img
          ...
          <div className="cust-container py-2 flex flex-col justify-center">
            <div className="drop-shadow-xl">
              <h3 className="font-bold text-center text-2xl mt-7 mb-5 text-cust-blue">
                Powered by <a href="https://bemfilkom.ub.ac.id" className="hover:border-b-2 opacity-80">BEM FILKOM UB 2024</a>
              </h3>
            </div>
