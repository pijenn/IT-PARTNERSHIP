...
const Services = () => {
  return (
    <div className="bg-cover bg-[0px] bg-fixed w-full pt-6 pb-28" style={{ backgroundImage: `url('https://res.cloudinary.com/dkncrhkfo/image/upload/v1716996264/bg-bgan_m75s58.png')` }}>
      <motion.div 
